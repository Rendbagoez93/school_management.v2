...
class TestUserModel:
    ...
    def test_user_initials_property(self, user_factory):
        ...
        # Test with only first name
        user_first_only = user_factory(first_name="John", last_name="", email="john@example.com")
    ...
    def test_birthday_check(self, user_factory):
        ...
        user_birthday_tomorrow = user_factory(date_of_birth=(date.today() + timedelta(days=1)))
